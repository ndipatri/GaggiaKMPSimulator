...
# This started an MQTT broker AND it launches an MQTT client
# that publishes telemetry.  You can use this INSTEAD of the
# interactive desktop simulator within ./composeApp
#
